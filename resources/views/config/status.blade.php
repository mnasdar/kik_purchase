@extends('layouts.vertical', ['title' => 'Status', 'sub_title' => 'Menu', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
    ...
    <div class="grid grid-cols-12">
        <div class="col-span-12">
            <div class="card">
                        ...
                        <div class="flex flex-row gap-2">
                            <div class="inline-flex items-center gap-1">
                                <span data-fc-target="addModal" data-fc-type="modal">
                                    <button class="btn bg-primary text-white p-2" title="Buat Status" tabindex="0"
                ...
                <div class="p-6">
                    <p class="text-sm text-slate-700 dark:text-slate-400 mb-4">Berikut adalah data status. Anda bisa
                        mencari
                        dan mengurutkan data secara naik atau turun. Setiap halaman menampilkan 10 item.
                    </p>
                    <!-- Disini tampilkan data -->
                    <div id="status-table" class="w-full overflow-x-auto"></div>
                </div>
            </div>
        </div>
    </div>
