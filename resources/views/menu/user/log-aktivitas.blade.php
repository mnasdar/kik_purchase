@extends('layouts.vertical', ['title' => 'Log Aktivitas', 'sub_title' => 'User Management', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="card-header">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">Riwayat aktivitas pengguna secara real-time</p>
                </div>
            </div>
        </div>
        <div class="p-6">
...
@section('script')
    @vite([
        ...
        'resources/js/custom/user-log/log/log-read.js',
        'resources/js/custom/user-log/log/log-detail.js',
    ])
@endsection
