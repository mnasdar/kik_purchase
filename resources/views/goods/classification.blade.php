@extends('layouts.vertical', ['title' => 'Classification', 'sub_title' => 'Goods', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="card">
                <div class="card-header">
                    <div class="flex md:flex-row flex-col justify-between items-start md:items-center">
                        <h4 class="card-title">Data Tables Classification</h4>
                ...
                <div class="p-6">
                    <p class="text-sm text-slate-700 dark:text-slate-400 mb-4">This All Of Classification Data,
                        You
                            ...
                            <div
                                ...
                                <div class="py-3 px-4">
                                    <div class="relative max-w-xs">
                                        ...
                                        <div id="searchRoute" data-search-url="{{ route('classification.search') }}"></div>
                                ...
                                <div class="overflow-hidden">
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody id="DatatableBody" class="divide-y divide-gray-200 dark:divide-gray-700">
                                            @include('goods.partials.classification_datatable', [
                                                'data' => $data,
                                            ])
                                        </tbody>
                                    </table>
...
@section('script')
    ...
    <script>
        window.routes = {
            routesEdit: "{{ route('classification.edit', ['classification' => '__ID__']) }}",
            routesUpdate: "{{ route('classification.update', ['classification' => '__ID__']) }}",
            routesDestroy: "{{ route('classification.destroy', ['classification' => '__ID__']) }}"
        };
    </script>
@endsection
