                            ...
                            <div
                                ...
                                <div class="py-3 px-4">
                                    <div class="relative max-w-xs">
                                        ...
                                        <div id="searchRoute" data-search-url="{{ route('purchase-orders.search') }}">
                                        </div>
                ...
                <div class="col-span-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="flex md:flex-row flex-col justify-between items-start md:items-center">
                                <div class="flex flex-row gap-2">
                                    <button type="button" id="btn-addpr"
                                        class="btn-addpr btn bg-primary text-white my-3" data-fc-target="addprModal"
                                ...
                                <div class="flex flex-row gap-2">
                                    <button class="btn bg-danger p-2 text-white btn-prdelete"
                                        data-fc-target="deleteprModal" data-fc-type="modal" type="button">
            ...
            <form action="{{ route('purchase-tracking.store') }}" id="addFormTracking" method="POST">
                ...
                <div class="px-4 py-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group col-span-2">
                            <label for="inputpurchase_request_id"
                            ...
                            <div class="p-0">
                                <select id="inputpurchase_request_id" name="purchase_request_id" class="search-select">
                                    ...
                                    @foreach ($purchaseRequests as $item)
                                        <option value="{{ $item->id }}">{{ $item->pr_number }} |
                                            {{ $item->item_desc }}
                                        </option>
                                    @endforeach
                                </select>
