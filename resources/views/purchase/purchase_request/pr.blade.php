@extends('layouts.vertical', ['title' => 'Purchase Request', 'sub_title' => ucwords($prefix), 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
    ...
    <div class="grid grid-cols-12">
        <div class="col-span-12">
            <div class="card">
                ...
                <div class="p-6">
                    <p class="text-sm text-slate-700 dark:text-slate-400 mb-4">Berikut adalah data purchase request Anda bisa mencari
                        dan mengurutkan data secara naik atau turun. Setiap halaman menampilkan 10 item.
                    </p>
                    <!-- Disini tampilkan data -->
                    <div id="purchase_request-table" class="w-full overflow-x-auto"></div>
                </div>
            </div>
        </div>
    </div>
