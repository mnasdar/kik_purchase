import{$ as n}from"./modal-handler-2823516c.js";import{f as S}from"./index-a4e39586.js";import{I}from"./id-7a0d5e4f.js";import{s as k}from"./index-88056f3d.js";import{b as y,a as D}from"./gridjs.module-3ea5c5ab.js";import{a as C,s as v}from"./notification-d92c8c7c.js";import"./_commonjsHelpers-725317a4.js";import"./parse-c3570fb2.js";import"./notification-5f085df9.js";S.localize(I);const u=new Set,h=new Map;n(document).ready(function(){T()});function T(){F(),O()}function F(){n.ajax({url:k("dari-vendor.get-onsites"),method:"GET",success:function(e){const s=[{id:"checkbox",name:y("div",{innerHTML:'<input type="checkbox" id="select-all-checkbox" class="form-checkbox rounded text-primary">'}),width:"60px",sort:!1,formatter:t=>y("div",{innerHTML:t})},{id:"po_number",name:"PO Number",width:"120px"},{id:"pr_number",name:"PR Number",width:"120px"},{id:"supplier",name:"Supplier",width:"150px"},{id:"item_desc",name:"Item Description",width:"200px"},{id:"unit_price",name:"Unit Price",width:"120px",sort:!1},{id:"quantity",name:"Qty",width:"100px",sort:!1},{id:"amount",name:"Amount",width:"120px",sort:!1},{id:"onsite_date",name:"Onsite Date",width:"120px"}],i=e.map(t=>[t.checkbox,t.po_number,t.pr_number,t.supplier,t.item_desc,t.unit_price,t.quantity,t.amount,t.onsite_date]);new D({columns:s,data:i,pagination:{limit:10},search:{enabled:!0,ignoreHiddenColumns:!1},sort:!0}).render(document.querySelector("#table-onsites")),setTimeout(()=>{N(),_()},300);const d=document.querySelector("#table-onsites");d&&new MutationObserver(()=>{_(),g()}).observe(d,{childList:!0,subtree:!0})},error:function(e){console.error("Error loading onsites:",e),C("Gagal memuat data PO Onsite","Error!")}})}function O(){const e=n("#toggle-table"),s=n("#selection-card-body");if(!e.length||!s.length)return;const i='<span class="flex items-center gap-2"><i class="mgc_minimize_line text-lg"></i><span>Sembunyikan tabel</span></span>',r='<span class="flex items-center gap-2"><i class="mgc_arrow_down_line text-lg"></i><span>Tampilkan tabel</span></span>';e.on("click",function(){const d=s.hasClass("hidden");s.toggleClass("hidden",!d),n(this).html(d?i:r)})}function N(){const e=n("#invoice-form-container"),s=n("#invoice-form"),i=n("#btn-cancel");n(document).on("change","#select-all-checkbox",function(){const t=n(this).is(":checked");n("input.row-checkbox").each(function(){const a=n(this);a.prop("checked",t),w(a,t)}),r(),g()}),n(document).on("change","input.row-checkbox",function(){const t=n(this),c=t.is(":checked");w(t,c),r(),g()});function r(){const t=n("input.row-checkbox"),c=t.length,a=t.filter(":checked").length,l=n("#select-all-checkbox");a===0?l.prop("checked",!1).prop("indeterminate",!1):a===c?l.prop("checked",!0).prop("indeterminate",!1):l.prop("checked",!1).prop("indeterminate",!0)}i.on("click",function(){u.clear(),h.clear(),n("input.row-checkbox").prop("checked",!1),r(),g()}),s.on("submit",function(t){t.preventDefault();const c=n(this),a=Array.from(u),l=c.find("input[name='invoice_number']").val(),o=c.find("input[name='received_date']").val(),p=c.find("input[name='sla_target']").val();if(!o||!o.trim()){v("Tanggal diterima tidak boleh kosong","warning",2e3);return}if(!p||parseInt(p)<1){v("SLA Target harus minimal 1 hari","warning",2e3);return}let b=o;if(o.includes("-")){const m=o.split("-");m.length===3&&m[0].length<=2&&(b=`${m[2]}-${m[1].padStart(2,"0")}-${m[0].padStart(2,"0")}`)}const f={invoices:a.map(m=>({onsite_id:m,invoice_number:l&&l.trim()?l.trim():null,received_date:b,sla_target:parseInt(p)}))};console.log("Sending invoice data:",f),d(f,c)});function d(t,c){const a=s.find('button[type="submit"]'),l=a.html();a.prop("disabled",!0).html('<i class="mgc_loader_2_line animate-spin"></i> Menyimpan...'),n.ajax({url:k("dari-vendor.store-multiple"),method:"POST",contentType:"application/json",data:JSON.stringify(t),headers:{"X-CSRF-TOKEN":n('meta[name="csrf-token"]').attr("content")},success:function(o){console.log("Success response:",o),v(o.message||"Invoice berhasil disimpan!","success",2e3),c.trigger("reset"),n("input.row-checkbox").prop("checked",!1),r(),e.addClass("hidden"),setTimeout(()=>{window.location.href=k("dari-vendor.index")},1500)},error:function(o){console.error("Error response:",o);let p="Gagal menyimpan invoice";o.responseJSON&&(o.responseJSON.message?p=o.responseJSON.message:o.responseJSON.errors&&(p=Object.values(o.responseJSON.errors).flat().join(", "))),C(p,"Error!")},complete:function(){a.prop("disabled",!1).html(l)}})}}function g(){const e=n("#invoice-form-container");if(u.size===0){e.addClass("hidden");return}e.removeClass("hidden"),A()}function A(){const e=n("#form-items-container"),s=n("#selected-items-summary");e.empty(),s.empty();let i=0;Array.from(h.values()).forEach(a=>{const l=a.po_number;a.pr_number;const o=a.supplier,p=a.item_desc,b=a.onsite_date||"-",f=parseFloat(a.unit_price)||0,m=parseFloat(a.quantity)||0,x=parseFloat(a.amount)||0;i+=x;const $=`
    ...
    `;s.append(r);let d="";u.forEach(a=>{d+=`<input type="hidden" name="onsite_ids[]" value="${a}">`});const t=`
