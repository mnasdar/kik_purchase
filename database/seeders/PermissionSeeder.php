...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            // Purchase Tracking
            [
                'name' => 'purchase-tracking.view',
                'display_name' => 'View Purchase Tracking',
                'description' => 'Can view purchase tracking',
                'category' => 'Purchase',
                'guard_name' => 'web',
            ],
            [
                'name' => 'purchase-tracking.update',
                'display_name' => 'Update Purchase Tracking',
                'description' => 'Can update purchase tracking status',
                'category' => 'Purchase',
                'guard_name' => 'web',
            ],
            ...
            [
                'name' => 'po-onsite.view',
                'display_name' => 'View PO Onsite',
                'description' => 'Can view onsite purchase orders',
                'category' => 'Purchase',
                'guard_name' => 'web',
            ],
            [
                'name' => 'po-onsite.create',
                'display_name' => 'Create PO Onsite',
                'description' => 'Can create onsite purchase orders',
                'category' => 'Purchase',
                'guard_name' => 'web',
            ],
            [
                'name' => 'po-onsite.edit',
                'display_name' => 'Edit PO Onsite',
                'description' => 'Can edit onsite purchase orders',
                'category' => 'Purchase',
                'guard_name' => 'web',
            ],
            [
                'name' => 'po-onsite.delete',
                'display_name' => 'Delete PO Onsite',
                'description' => 'Can delete onsite purchase orders',
                'category' => 'Purchase',
                'guard_name' => 'web',
            ],
            ...
            [
                ...
                'description' => 'Can view invoices list',
                'category' => 'Invoice',
                'guard_name' => 'web',
            ],
            [
            ...
            [
                ...
                'description' => 'Can view payments list',
                'category' => 'Invoice',
                'guard_name' => 'web',
            ],
            [
            ...
            [
                ...
                'description' => 'Can edit existing payments',
                'category' => 'Invoice',
                'guard_name' => 'web',
            ],
            [
